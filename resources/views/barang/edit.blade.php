                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="harga_sewa" name="harga_sewa"
                                            value="{{ $data['barang']->harga_sewa }}">
                                    </div>

                                    <div class="form-group">
                                        <label style="color: #6c757d">Deskripsi</label>
                                        <textarea name="deskripsi" class="form-control" rows="3" placeholder="Enter ...">{{ $data['barang']->deskripsi }}</textarea>
                                    </div>
                                    <div class="form-group">
        ...
        <script>
            $(document).ready(function() {
                $('.input-images').imageUploader({
                    ...
                    preloaded: [
                        @foreach ( $data['barang']->gambar as $i)
                            {
                                id: '{{ $i->file }}',
                                src: '{{ URL::to($i->file) }}'
                            },
